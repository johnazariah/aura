...
const healthCheckService_1 = __webpack_require__(4);
const auraApiService_1 = __webpack_require__(83);
let auraApiService;
...
async function activate(context) {
    ...
    // Add disposables
    context.subscriptions.push(statusView, agentView, statusBarItem, refreshCommand, startCommand, stopCommand, executeAgentCommand, quickExecuteCommand, selectAgentCommand, indexWorkspaceCommand, askWithRagCommand, showRagStatsCommand, clearRagIndexCommand, configWatcher);
    // Initial refresh
    await refreshAll();
    // Setup auto-refresh
    setupAutoRefresh();
...
async function askWithRag(agentId, agentName) {
    try {
        ...
        await vscode.window.withProgress({
            ...
            const result = await auraApiService.executeAgentWithRag(agentId, prompt, workspacePath, 5 // Top 5 results
            );
...
function formatRagResponse(agentName, prompt, result) {
...
const proxyFromEnv = __webpack_require__(67);
const http = __webpack_require__(12);
const https = __webpack_require__(13);
const http2 = __webpack_require__(68);
const util = __webpack_require__(8);
const followRedirects = __webpack_require__(69);
...
module.exports = function () {
  if (!debug) {
    try {
      ...
      debug = __webpack_require__(72)("follow-redirects");
    }
    catch (error) { /* */ }
...
const tty = __webpack_require__(77);
const util = __webpack_require__(8);
...
try {
	...
	const supportsColor = __webpack_require__(78);
