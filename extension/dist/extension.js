...
async function activate(context) {
    ...
    // Add disposables
    context.subscriptions.push(statusView, agentView, statusBarItem, refreshCommand, startCommand, stopCommand, executeAgentCommand, quickExecuteCommand, selectAgentCommand, configWatcher);
    // Initial refresh
    await refreshAll();
    // Setup auto-refresh
    setupAutoRefresh();
...
class AuraApiService {
    ...
    async executeAgent(agentId, prompt, workspacePath) {
        const response = await this.httpClient.post(`${this.getBaseUrl()}/api/agents/${agentId}/execute`, { prompt, workspacePath }, { timeout: this.getExecutionTimeout() } // Use longer timeout for LLM execution
        );
