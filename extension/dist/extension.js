...
async function activate(context) {
    ...
    // Initialize services
    const auraApiService = new auraApiService_1.AuraApiService();
    ...
    // Add disposables
    context.subscriptions.push(statusView, agentView, statusBarItem, refreshCommand, startCommand, stopCommand, configWatcher);
    // Initial refresh
    await refreshAll();
    // Setup auto-refresh
    setupAutoRefresh();
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
exports.AgentItem = exports.AgentTreeProvider = void 0;
const vscode = __importStar(__webpack_require__(1));
...
class AgentItem extends vscode.TreeItem {
    agent;
    constructor(agent, isPlaceholder = false) {
