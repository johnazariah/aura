...
- [x] Squashed migrations into single `InitialCreate` per context
  - `Aura.Foundation/Data/Migrations/20260130050642_InitialCreate.cs`
  - `Aura.Module.Developer/Data/Migrations/20260130050710_InitialCreate.cs`
...
- [Unified Wave Orchestration](../completed/unified-wave-orchestration.md) - Story execution cleanup
- [API Harmonization](../completed/api-review-harmonization.md) - API consistency
- [Database Schema Cleanup](../completed/database-schema-cleanup.md) - Schema normalization
