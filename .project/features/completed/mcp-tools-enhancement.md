...
Additional language support (TypeScript via ts-morph, Go/Rust/Java via LSP) is planned in a separate spec:

→ **See:** [Multi-Language Refactoring](../upcoming/multi-language-refactoring.md)
...
- ✅ 8 consolidated MCP tools (was 28)
