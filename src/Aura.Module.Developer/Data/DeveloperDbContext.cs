...
/// Initializes a new instance of the <see cref="DeveloperDbContext"/> class.
    ...
    public DbSet<Workflow> Workflows => Set<Workflow>();    /// <summary>Gets the workflow steps.</summary>
    ...
    private static void ConfigureDeveloperEntities(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<Workflow>(entity =>
        {
            ...
            entity.HasOne(e => e.Issue)
                ...
                .HasForeignKey<Workflow>(e => e.IssueId)
                .OnDelete(DeleteBehavior.SetNull);

            entity.HasIndex(e => e.IssueId).IsUnique();
