...
public interface ICodeGraphService
{
    ...
    /// <param name="workspacePath">Optional workspace path for isolation.</param>
    ...
    /// <summary>
    /// Clears the graph for a workspace (before re-indexing).
    /// </summary>
    /// <param name="workspacePath">The workspace path.</param>
    /// <param name="cancellationToken">Cancellation token.</param>
    Task ClearWorkspaceGraphAsync(string workspacePath, CancellationToken cancellationToken = default);
