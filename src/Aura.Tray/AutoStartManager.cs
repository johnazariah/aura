...
/// Windows: Registry run key. macOS: LaunchAgent plist. Linux: XDG autostart.
/// </summary>
public static class AutoStartManager
{
    ...
    private static string GetExecutablePath()
    {
        return Environment.ProcessPath
            ?? Path.Combine(AppContext.BaseDirectory,
                RuntimeInformation.IsOSPlatform(OSPlatform.Windows) ? "Aura.Tray.exe" : "Aura.Tray");
    }
    ...
    private static bool EnableLinuxAutoStart()
    {
        ...
        var content = $"""
            ...
            Type=Application
            Name=Aura Tray
            Comment=System tray for Aura knowledge indexer status
